        ...
        <section className="max-w-4xl mx-auto px-8 py-16">
            ...
            <div className="space-y-4">
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  How do I create my first desktop?
                </h3>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  How do I transfer files to my desktop?
                </h3>
                <p className="text-gray-600">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  What happens to my data if I delete a desktop?
                </h3>
                <p className="text-gray-600">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  Can I use GPU-accelerated desktops?
                </h3>
                <p className="text-gray-600">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              <Badge variant="error">Security & Privacy</Badge>
              <h2 className="text-2xl font-semibold text-gray-900">
                Security & Privacy
              </h2>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  Can I upgrade my desktop resources without downtime?
                </h3>
                <p className="text-gray-600">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  How many students can I have in a classroom?
                </h3>
                <p className="text-gray-600">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  Can students access their desktops outside of class?
                </h3>
                <p className="text-gray-600">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  How do I distribute assignments to students?
                </h3>
                <p className="text-gray-600">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4">
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  Does CloudDesk integrate with my LMS?
                </h3>
                <p className="text-gray-600 mb-4">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  Can I connect to external databases or services?
                </h3>
                <p className="text-gray-600">
